...
type Subject = Record<EmailOtpType, string>;
...
const subjects: Record<Language, Subject> = {
  en: {
    ...
    email: "Confirm New Email Address",
  },
  fr: {
    ...
    email: "Confirmez la nouvelle adresse e-mail",
  },
};
...
const bodies: Record<Language, Subject> = {
  en: {
    ...
    email: `<h2>Confirm New Email Address</h2><p>Follow this link to confirm your new email address:</p><p><a href="{{confirmation_url}}">Confirm new email address</a></p><p>Alternatively, enter the code: {{new_token}}</p>`,
  },
  fr: {
    ...
    email: `<h2>Confirmez la nouvelle adresse e-mail</h2><p>Suivez ce lien pour confirmer votre nouvelle adresse e-mail :</p><p><a href="{{confirmation_url}}">Confirmez la nouvelle adresse e-mail</a></p><p>Vous pouvez aussi saisir le code : {{new_token}}</p>`,
  },
};
